#pragma once
/**
 * @file	MassHelicityAnglesImagCachedIntegral.h
 * @date	May 23, 2011
 * @author	mprim
...
#ifndef MASSHELICITYANGLESIMAGCACHEDINTEGRAL_H_
#define MASSHELICITYANGLESIMAGCACHEDINTEGRAL_H_
 ...
 */
class MassHelicityAnglesImagCachedIntegral : public MassHelicityAnglesCoreCachedIntegral {
public:
	MassHelicityAnglesImagCachedIntegral() : MassHelicityAnglesCoreCachedIntegral() {};
	MassHelicityAnglesImagCachedIntegral(const std::vector<std::pair<double, double> >& limits,
	...
	virtual ROOT::Math::IBaseFunctionMultiDim* Clone() const {
		MassHelicityAnglesImagCachedIntegral* f = new MassHelicityAnglesImagCachedIntegral(*this);
		return f;
	}

	virtual std::string GetIntegralClassIdentifier() const {
		return "MassHelicityAnglesImagCachedIntegral";
	}
};

#endif /* MASSHELICITYANGLESIMAGCACHEDINTEGRAL_H_ */
