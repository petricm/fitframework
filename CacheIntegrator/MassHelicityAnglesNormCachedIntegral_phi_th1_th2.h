#pragma once
/**
 * @file	MassHelicityAnglesNormCachedIntegral_phi_th1_th2.h
 * @date	May 23, 2011
 * @author	mprim
...
#ifndef MASSHELICITYANGLESNORMCACHEDINTEGRAL_phi_th1_th2_H_
#define MASSHELICITYANGLESNORMCACHEDINTEGRAL_phi_th1_th2_H_
 ...
 */
class MassHelicityAnglesNormCachedIntegral_phi_th1_th2 : public MassHelicityAnglesCoreCachedIntegral {
public:
	MassHelicityAnglesNormCachedIntegral_phi_th1_th2() : MassHelicityAnglesCoreCachedIntegral() {};
	MassHelicityAnglesNormCachedIntegral_phi_th1_th2(const std::vector<std::pair<double, double> >& limits,
	...
	virtual ROOT::Math::IBaseFunctionMultiDim* Clone() const {
		MassHelicityAnglesNormCachedIntegral_phi_th1_th2* f = new MassHelicityAnglesNormCachedIntegral_phi_th1_th2(*this);
		return f;
	}

	virtual std::string GetIntegralClassIdentifier() const {
		return "MassHelicityAnglesNormCachedIntegral_phi_th1_th2";
	}
};

#endif /* MASSHELICITYANGLESNORMCACHEDINTEGRAL_phi_th1_th2_H_ */
