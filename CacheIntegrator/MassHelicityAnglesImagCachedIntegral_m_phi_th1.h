#pragma once
/**
 * @file	MassHelicityAnglesImagCachedIntegral_m_phi_th1.h
 * @date	May 23, 2011
 * @author	mprim
...
#ifndef MASSHELICITYANGLESIMAGCACHEDINTEGRAL_m_phi_th1_H_
#define MASSHELICITYANGLESIMAGCACHEDINTEGRAL_m_phi_th1_H_
 ...
 */
class MassHelicityAnglesImagCachedIntegral_m_phi_th1 : public MassHelicityAnglesCoreCachedIntegral {
public:
	MassHelicityAnglesImagCachedIntegral_m_phi_th1() : MassHelicityAnglesCoreCachedIntegral() {};
	MassHelicityAnglesImagCachedIntegral_m_phi_th1(const std::vector<std::pair<double, double> >& limits,
	...
	virtual ROOT::Math::IBaseFunctionMultiDim* Clone() const {
		MassHelicityAnglesImagCachedIntegral_m_phi_th1* f = new MassHelicityAnglesImagCachedIntegral_m_phi_th1(*this);
		return f;
	}

	virtual std::string GetIntegralClassIdentifier() const {
		return "MassHelicityAnglesImagCachedIntegral_m_phi_th1";
	}
};

#endif /* MASSHELICITYANGLESIMAGCACHEDINTEGRAL_m_phi_th1_H_ */
