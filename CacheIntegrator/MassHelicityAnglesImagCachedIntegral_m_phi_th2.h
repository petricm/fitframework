#pragma once
/**
 * @file	MassHelicityAnglesImagCachedIntegral_m_phi_th2.h
 * @date	May 23, 2011
 * @author	mprim
...
#ifndef MASSHELICITYANGLESIMAGCACHEDINTEGRAL_m_phi_th2_H_
#define MASSHELICITYANGLESIMAGCACHEDINTEGRAL_m_phi_th2_H_
 ...
 */
class MassHelicityAnglesImagCachedIntegral_m_phi_th2 : public MassHelicityAnglesCoreCachedIntegral {
public:
	MassHelicityAnglesImagCachedIntegral_m_phi_th2() : MassHelicityAnglesCoreCachedIntegral() {};
	MassHelicityAnglesImagCachedIntegral_m_phi_th2(const std::vector<std::pair<double, double> >& limits,
	...
	virtual double DoEval(const double* x) const {
		...
		// cos_th1
		double th1 = std::acos(m_parameters[19]);
	...
	virtual ROOT::Math::IBaseFunctionMultiDim* Clone() const {
		MassHelicityAnglesImagCachedIntegral_m_phi_th2* f = new MassHelicityAnglesImagCachedIntegral_m_phi_th2(*this);
		return f;
	}

	virtual std::string GetIntegralClassIdentifier() const {
		return "MassHelicityAnglesImagCachedIntegral_m_phi_th2";
	}
};

#endif /* MASSHELICITYANGLESIMAGCACHEDINTEGRAL_m_phi_th2_H_ */
