#pragma once
/**
 * @file	MassHelicityAnglesNormCachedIntegral.h
 * @date	May 23, 2011
 * @author	mprim
...
#ifndef MASSHELICITYANGLESNORMCACHEDINTEGRAL_H_
#define MASSHELICITYANGLESNORMCACHEDINTEGRAL_H_
 ...
 */
class MassHelicityAnglesNormCachedIntegral : public MassHelicityAnglesCoreCachedIntegral {
public:
	MassHelicityAnglesNormCachedIntegral() : MassHelicityAnglesCoreCachedIntegral() {};
	MassHelicityAnglesNormCachedIntegral(const std::vector<std::pair<double, double> >& limits,
	...
	virtual ROOT::Math::IBaseFunctionMultiDim* Clone() const {
		MassHelicityAnglesNormCachedIntegral* f = new MassHelicityAnglesNormCachedIntegral(*this);
		return f;
	}

	virtual std::string GetIntegralClassIdentifier() const {
		return "MassHelicityAnglesNormCachedIntegral";
	}
};

#endif /* MASSHELICITYANGLESNORMCACHEDINTEGRAL_H_ */
