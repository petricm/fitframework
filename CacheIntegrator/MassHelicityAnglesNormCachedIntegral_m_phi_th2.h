#pragma once
/**
 * @file	MassHelicityAnglesNormCachedIntegral_m_phi_th2.h
 * @date	May 23, 2011
 * @author	mprim
...
#ifndef MASSHELICITYANGLESNORMCACHEDINTEGRAL_m_phi_th2_H_
#define MASSHELICITYANGLESNORMCACHEDINTEGRAL_m_phi_th2_H_
 ...
 */
class MassHelicityAnglesNormCachedIntegral_m_phi_th2 : public MassHelicityAnglesCoreCachedIntegral {
public:
	MassHelicityAnglesNormCachedIntegral_m_phi_th2() : MassHelicityAnglesCoreCachedIntegral() {};
	MassHelicityAnglesNormCachedIntegral_m_phi_th2(const std::vector<std::pair<double, double> >& limits,
	...
	virtual ROOT::Math::IBaseFunctionMultiDim* Clone() const {
		MassHelicityAnglesNormCachedIntegral_m_phi_th2* f = new MassHelicityAnglesNormCachedIntegral_m_phi_th2(*this);
		return f;
	}

	virtual std::string GetIntegralClassIdentifier() const {
		return "MassHelicityAnglesNormCachedIntegral_m_phi_th2";
	}
};

#endif /* MASSHELICITYANGLESNORMCACHEDINTEGRAL_m_phi_th2_H_ */
