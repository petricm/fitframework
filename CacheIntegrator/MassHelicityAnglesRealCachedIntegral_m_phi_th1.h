#pragma once
/**
 * @file	MassHelicityAnglesRealCachedIntegral_m_phi_th1.h
 * @date	May 23, 2011
 * @author	mprim
...
#ifndef MASSHELICITYANGLESREALCACHEDINTEGRAL_m_phi_th1_H_
#define MASSHELICITYANGLESREALCACHEDINTEGRAL_m_phi_th1_H_
 ...
 */
class MassHelicityAnglesRealCachedIntegral_m_phi_th1 : public MassHelicityAnglesCoreCachedIntegral {
public:
	MassHelicityAnglesRealCachedIntegral_m_phi_th1() : MassHelicityAnglesCoreCachedIntegral() {};
	MassHelicityAnglesRealCachedIntegral_m_phi_th1(const std::vector<std::pair<double, double> >& limits,
	...
	virtual ROOT::Math::IBaseFunctionMultiDim* Clone() const {
		MassHelicityAnglesRealCachedIntegral_m_phi_th1* f = new MassHelicityAnglesRealCachedIntegral_m_phi_th1(*this);
		return f;
	}

	virtual std::string GetIntegralClassIdentifier() const {
		return "MassHelicityAnglesRealCachedIntegral_m_phi_th1";
	}
};

#endif /* MASSHELICITYANGLESREALCACHEDINTEGRAL_m_phi_th1_H_ */
