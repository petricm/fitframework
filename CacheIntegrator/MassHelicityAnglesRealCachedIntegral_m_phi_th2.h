#pragma once
/**
 * @file	MassHelicityAnglesRealCachedIntegral_m_phi_th2.h
 * @date	May 23, 2011
 * @author	mprim
...
#ifndef MASSHELICITYANGLESREALCACHEDINTEGRAL_m_phi_th2_H_
#define MASSHELICITYANGLESREALCACHEDINTEGRAL_m_phi_th2_H_
 ...
 */
class MassHelicityAnglesRealCachedIntegral_m_phi_th2 : public MassHelicityAnglesCoreCachedIntegral {
public:
	MassHelicityAnglesRealCachedIntegral_m_phi_th2() : MassHelicityAnglesCoreCachedIntegral() {};
	MassHelicityAnglesRealCachedIntegral_m_phi_th2(const std::vector<std::pair<double, double> >& limits,
	...
	virtual ROOT::Math::IBaseFunctionMultiDim* Clone() const {
		MassHelicityAnglesRealCachedIntegral_m_phi_th2* f = new MassHelicityAnglesRealCachedIntegral_m_phi_th2(*this);
		return f;
	}

	virtual std::string GetIntegralClassIdentifier() const {
		return "MassHelicityAnglesRealCachedIntegral_m_phi_th2";
	}
};

#endif /* MASSHELICITYANGLESREALCACHEDINTEGRAL_m_phi_th2_H_ */
