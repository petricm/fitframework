...
#include "RooKKInterferenceNegative.h"
...
ClassImp(RooKKInterferenceNegative)

RooKKInterferenceNegative::RooKKInterferenceNegative(const char *name, const char *title,
		RooAbsReal& _m,
		RooAbsReal& _phi,
		RooAbsReal& _cos_th1,
		RooAbsReal& _cos_th2,
...
RooKKInterferenceNegative::RooKKInterferenceNegative(const RooKKInterferenceNegative& other, const char* name) :
...
Double_t RooKKInterferenceNegative::evaluate() const {
...
//	if(amplitude < 0) {
//		std::cout << "ERR: Amplitude smaller than 0 for A_10 = (" << amp_phi_long << "," << phase_phi_long
//				<< ") and A_f = (" << amp_flatte << "," << phase_flatte << ") \n";
//	}

	return amplitude < 0 ? -1 * acceptance * amplitude * F : 0.0;
}

Int_t RooKKInterferenceNegative::getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analVars, const char* /* rangeName */) const {
...
Double_t RooKKInterferenceNegative::analyticalIntegral(Int_t code, const char* rangeName ) const {
