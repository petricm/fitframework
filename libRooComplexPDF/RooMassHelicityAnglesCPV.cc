...
#include "RooMassHelicityAnglesCPV.h"
...
ClassImp(RooMassHelicityAnglesCPV)

RooMassHelicityAnglesCPV::RooMassHelicityAnglesCPV(const char *name, const char *title,
		RooAbsReal& _m,
		RooAbsReal& _phi,
		RooAbsReal& _cos_th1,
		RooAbsReal& _cos_th2,
		...
		amp_00_CC("amp_00_CC","amp_00_CC",this,*_s_cc_parameters._amp_00_CC),
		phase_00_CC("phase_00_CC","phase_00_CC",this,*_s_cc_parameters._phase_00_CC),
		amp_10_CC("amp_10_CC","amp_10_CC",this,*_s_cc_parameters._amp_10_CC),
		phase_10_CC("phase_10_CC","phase_10_CC",this,*_s_cc_parameters._phase_10_CC),
		amp_1para_CC("amp_1para_CC","amp_1para_CC",this,*_s_cc_parameters._amp_1para_CC),
		phase_1para_CC("phase_1para_CC","phase_1para_CC",this,*_s_cc_parameters._phase_1para_CC),
		amp_1perp_CC("amp_1perp_CC","amp_1perp_CC",this,*_s_cc_parameters._amp_1perp_CC),
		phase_1perp_CC("phase_1perp_CC","phase_1perp_CC",this,*_s_cc_parameters._phase_1perp_CC),
		amp_20_CC("amp_20_CC","amp_20_CC",this,*_s_cc_parameters._amp_20_CC),
		phase_20_CC("phase_20_CC","phase_20_CC",this,*_s_cc_parameters._phase_20_CC),
		amp_2para_CC("amp_2para_CC","amp_2para_CC",this,*_s_cc_parameters._amp_2para_CC),
		phase_2para_CC("phase_2para_CC","phase_2para_CC",this,*_s_cc_parameters._phase_2para_CC),
		amp_2perp_CC("amp_2perp_CC","amp_2perp_CC",this,*_s_cc_parameters._amp_2perp_CC),
		phase_2perp_CC("phase_2perp_CC","phase_2perp_CC",this,*_s_cc_parameters._phase_2perp_CC),
		m_Pi(_s_PDG.m_Pi),
		m_K(_s_PDG.m_K),
		m_Phi(_s_PDG.m_Phi),
		m_B0(_s_PDG.m_B0),
...
RooMassHelicityAnglesCPV::RooMassHelicityAnglesCPV(const RooMassHelicityAnglesCPV& other, const char* name) :
	   ...
	   amp_00_CC("amp_00_CC",this,other.amp_00_CC),
	   phase_00_CC("phase_00_CC",this,other.phase_00_CC),
	   amp_10_CC("amp_10_CC",this,other.amp_10_CC),
	   phase_10_CC("phase_10_CC",this,other.phase_10_CC),
	   amp_1para_CC("amp_1para_CC",this,other.amp_1para_CC),
	   phase_1para_CC("phase_1para_CC",this,other.phase_1para_CC),
	   amp_1perp_CC("amp_1perp_CC",this,other.amp_1perp_CC),
	   phase_1perp_CC("phase_1perp_CC",this,other.phase_1perp_CC),
	   amp_20_CC("amp_20_CC",this,other.amp_20_CC),
	   phase_20_CC("phase_20_CC",this,other.phase_20_CC),
	   amp_2para_CC("amp_2para_CC",this,other.amp_2para_CC),
	   phase_2para_CC("phase_2para_CC",this,other.phase_2para_CC),
	   amp_2perp_CC("amp_2perp_CC",this,other.amp_2perp_CC),
	   phase_2perp_CC("phase_2perp_CC",this,other.phase_2perp_CC),
	   m_Pi(other.m_Pi),
	   m_K(other.m_K),
	   m_Phi(other.m_Phi),
	   m_B0(other.m_B0),
...
Double_t RooMassHelicityAnglesCPV::evaluate() const {
	...
	if(0 == channel) { // state CP
	...
	} else if (1 == channel) { // state CA
		// amplitude vectors J=0,1,2
		// Spin J=0 (only long.)
		std::vector<std::complex<double> > A_0; A_0.reserve(1);
		A_0.push_back(std::polar((double)amp_00_CC,(double)phase_00_CC));
		// Spin J=1 (lambda -1,0,1)
		std::complex<double> A_1para = std::polar((double)amp_1para_CC,(double)phase_1para_CC);
		std::complex<double> A_1perp = std::polar((double)amp_1perp_CC,(double)phase_1perp_CC);
		std::vector<std::complex<double> > A_1; A_1.reserve(3);
		A_1.push_back((A_1para - A_1perp)/std::sqrt(2));
		A_1.push_back(std::polar((double)amp_10_CC,(double)phase_10_CC));
		A_1.push_back((A_1para + A_1perp)/std::sqrt(2));
		// Spin J=2 (lambda -1,0,1)
		std::complex<double> A_2para = std::polar((double)amp_2para_CC,(double)phase_2para_CC);
		std::complex<double> A_2perp = std::polar((double)amp_2perp_CC,(double)phase_2perp_CC);
		std::vector<std::complex<double> > A_2; A_2.reserve(3);
		A_2.push_back((A_2para - A_2perp)/std::sqrt(2));
		A_2.push_back(std::polar((double)amp_20_CC,(double)phase_20_CC));
		A_2.push_back((A_2para + A_2perp)/std::sqrt(2));
		...
		std::cerr << "ERROR: Unsupported channel type channel =" << channel << " in RooMassHelicityAnglesCPV::evaluatel(...) --> Return 1.0" << std::endl;
		return 1.0;
	}
}

Int_t RooMassHelicityAnglesCPV::getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analVars, const char* /* rangeName */) const {
...
Double_t RooMassHelicityAnglesCPV::analyticalIntegral(Int_t code, const char* rangeName ) const {
	return analyticalIntegralAndAsymmetry(code,rangeName).first;
}

Double_t RooMassHelicityAnglesCPV::getAsymmetry(const char* rangeName ) const {
	return analyticalIntegralAndAsymmetry(5,rangeName).second;
}

std::pair<Double_t,Double_t> RooMassHelicityAnglesCPV::analyticalIntegralAndAsymmetry(Int_t code, const char* rangeName ) const {
	// J and lambda values of each amplitude
	const int J_values[7]      = {0, 1,1,1, 2,2,2};
	const int lambda_values[7] = {0,-1,0,1,-1,0,1};
	// complex weights
	std::complex<double> A_1para = std::polar((double)amp_1para,(double)phase_1para);
	std::complex<double> A_1perp = std::polar((double)amp_1perp,(double)phase_1perp);
	std::complex<double> A_2para = std::polar((double)amp_2para,(double)phase_2para);
	...
	// complex weights CC
	std::complex<double> A_1para_CC = std::polar((double)amp_1para_CC,(double)phase_1para_CC);
	std::complex<double> A_1perp_CC = std::polar((double)amp_1perp_CC,(double)phase_1perp_CC);
	std::complex<double> A_2para_CC = std::polar((double)amp_2para_CC,(double)phase_2para_CC);
	std::complex<double> A_2perp_CC = std::polar((double)amp_2perp_CC,(double)phase_2perp_CC);
	const double amps_CC[7]  = {amp_00_CC,  std::abs((A_1para_CC - A_1perp_CC)/std::sqrt(2)),  amp_10_CC,std::abs((A_1para_CC + A_1perp_CC)/std::sqrt(2)),std::abs((A_2para_CC - A_2perp_CC)/std::sqrt(2)),  amp_20_CC,std::abs((A_2para_CC + A_2perp_CC)/std::sqrt(2))};
	const double phase_CC[7] = {phase_00_CC,std::arg((A_1para_CC - A_1perp_CC)/std::sqrt(2)),phase_10_CC,std::arg((A_1para_CC + A_1perp_CC)/std::sqrt(2)),std::arg((A_2para_CC - A_2perp_CC)/std::sqrt(2)),phase_20_CC,std::arg((A_2para_CC + A_2perp_CC)/std::sqrt(2))};
	...
	if (code == 5) {
		...
		for(unsigned int i = 0; i < 7; ++i) {
			for(unsigned int j = 0; j < 7; ++j) {
				...
				// switch between the three different types of integrals
				if(i==j) { // integral |A_i|^2
					double integral = m_norm_cache_integrator_phi_th1_th2->GetIntegral(limits,parameters);
					M += amps[i]*amps[j]*integral;
					M_CC += amps_CC[i]*amps_CC[j]*integral;
				} else if (i < j) { // integral Re(A_i A_j*)
					double integral = m_real_cache_integrator_phi_th1_th2->GetIntegral(limits,parameters);
					M += 2*amps[i]*amps[j]*std::cos(phase[i]-phase[j])*integral;
					M_CC += 2*amps_CC[i]*amps_CC[j]*std::cos(phase_CC[i]-phase_CC[j])*integral;
				} else if (i > j) { // integral Im(A_i A_j*)
					// flip i and j components, as always A_j needs to be cc
					std::swap(parameters[0],parameters[2]);
					std::swap(parameters[1],parameters[3]);
					double integral = m_imag_cache_integrator_phi_th1_th2->GetIntegral(limits,parameters);
					M -= 2*amps[i]*amps[j]*std::sin(phase[j]-phase[i])*integral;
					M_CC -= 2*amps_CC[i]*amps_CC[j]*std::sin(phase_CC[j]-phase_CC[i])*integral;
				}
			}
		...
		for(unsigned int i = 0; i < 7; ++i) {
			for(unsigned int j = 0; j < 7; ++j) {
				...
				// switch between the three different types of integrals
				if(i==j) { // integral |A_i|^2
					double integral = m_norm_cache_integrator_m_th1_th2->GetIntegral(limits,parameters);
					M += amps[i]*amps[j]*integral;
					M_CC += amps_CC[i]*amps_CC[j]*integral;
				} else if (i < j) { // integral Re(A_i A_j*)
					double integral = m_real_cache_integrator_m_th1_th2->GetIntegral(limits,parameters);
					M += 2*amps[i]*amps[j]*std::cos(phase[i]-phase[j])*integral;
					M_CC += 2*amps_CC[i]*amps_CC[j]*std::cos(phase_CC[i]-phase_CC[j])*integral;
				} else if (i > j) { // integral Im(A_i A_j*)
					// flip i and j components, as always A_j needs to be cc
					std::swap(parameters[0],parameters[2]);
					std::swap(parameters[1],parameters[3]);
					double integral = m_imag_cache_integrator_m_th1_th2->GetIntegral(limits,parameters);
					M -= 2*amps[i]*amps[j]*std::sin(phase[j]-phase[i])*integral;
					M_CC -= 2*amps_CC[i]*amps_CC[j]*std::sin(phase_CC[j]-phase_CC[i])*integral;
				}
			}
		...
		for(unsigned int i = 0; i < 7; ++i) {
			for(unsigned int j = 0; j < 7; ++j) {
				...
				// switch between the three different types of integrals
				if(i==j) { // integral |A_i|^2
					double integral = m_norm_cache_integrator_m_phi_th2->GetIntegral(limits,parameters);
					M += amps[i]*amps[j]*integral;
					M_CC += amps_CC[i]*amps_CC[j]*integral;
				} else if (i < j) { // integral Re(A_i A_j*)
					double integral = m_real_cache_integrator_m_phi_th2->GetIntegral(limits,parameters);
					M += 2*amps[i]*amps[j]*std::cos(phase[i]-phase[j])*integral;
					M_CC += 2*amps_CC[i]*amps_CC[j]*std::cos(phase_CC[i]-phase_CC[j])*integral;
				} else if (i > j) { // integral Im(A_i A_j*)
					// flip i and j components, as always A_j needs to be cc
					std::swap(parameters[0],parameters[2]);
					std::swap(parameters[1],parameters[3]);
					double integral = m_imag_cache_integrator_m_phi_th2->GetIntegral(limits,parameters);
					M -= 2*amps[i]*amps[j]*std::sin(phase[j]-phase[i])*integral;
					M_CC -= 2*amps_CC[i]*amps_CC[j]*std::sin(phase_CC[j]-phase_CC[i])*integral;
				}
			}
		...
		for(unsigned int i = 0; i < 7; ++i) {
			for(unsigned int j = 0; j < 7; ++j) {
				...
				// switch between the three different types of integrals
				if(i==j) { // integral |A_i|^2
					double integral = m_norm_cache_integrator_m_phi_th1->GetIntegral(limits,parameters);
					M += amps[i]*amps[j]*integral;
					M_CC += amps_CC[i]*amps_CC[j]*integral;
				} else if (i < j) { // integral Re(A_i A_j*)
					double integral = m_real_cache_integrator_m_phi_th1->GetIntegral(limits,parameters);
					M += 2*amps[i]*amps[j]*std::cos(phase[i]-phase[j])*integral;
					M_CC += 2*amps_CC[i]*amps_CC[j]*std::cos(phase_CC[i]-phase_CC[j])*integral;
				} else if (i > j) { // integral Im(A_i A_j*)
					// flip i and j components, as always A_j needs to be cc
					std::swap(parameters[0],parameters[2]);
					std::swap(parameters[1],parameters[3]);
					double integral = m_imag_cache_integrator_m_phi_th1->GetIntegral(limits,parameters);
					M -= 2*amps[i]*amps[j]*std::sin(phase[j]-phase[i])*integral;
					M_CC -= 2*amps_CC[i]*amps_CC[j]*std::sin(phase_CC[j]-phase_CC[i])*integral;
				}
			}
