...
#ifndef ROOKKINTERFERENCENEGATIVE
#define ROOKKINTERFERENCENEGATIVE
...
class RooKKInterferenceNegative : public RooAbsPdf {
public:
	RooKKInterferenceNegative() : m_acceptance_function(UNIFORM), m_1a(0), m_1b(0), m_2a(0), m_2b(0), m_3a(0), m_3b(0), m1(0), m2(0), m3(0), mM(0),
							m_norm_cache_integrator(NULL), m_real_cache_integrator(NULL), m_imag_cache_integrator(NULL) {} ;
	RooKKInterferenceNegative(const char *name, const char *title,
			RooAbsReal& _m,
			RooAbsReal& _phi,
			RooAbsReal& _cos_th1,
			RooAbsReal& _cos_th2,
	...
	RooKKInterferenceNegative(const RooKKInterferenceNegative& other, const char* name=0) ;
	virtual TObject* clone(const char* newname) const { return new RooKKInterferenceNegative(*this,newname); }
	inline virtual ~RooKKInterferenceNegative() { }
...
private:
	...
	ClassDef(RooKKInterferenceNegative,1) // Your description goes here...
};
